...
// Data
import { cnpjData } from '../../data/index';
      ...
      <Header />
        ...
        <main>
          ...
          <div className="termos font-2-s cor-10 container">
            ...
            Este site oferece serviços de assinatura de boletim informativo ou e-mail e os cookies podem ser usados ​​para lembrar se você já está registrado e se deve mostrar determinadas notificações válidas apenas para usuários inscritos ou não inscritos.</p>
            ...
            Para proporcionar uma ótima experiência neste site, fornecemos a funcionalidade para definir suas preferências de como esse site é executado quando você o usa. Para lembrar suas preferências, precisamos definir cookies para que essas informações sejam chamadas sempre que você interagir com uma página.</p>
            <p>Cookies de Terceiros
            ...
            <p>O usuário se compromete a fazer uso adequado do conteúdo e informações que o teste oferece no site, com caráter enunciativo, mas não limitativo:</p>
            <p>a - Não se envolver em atividades que sejam ilegais ou contrárias à boa fé a à ordem pública;</p>
            <p>b - Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, ou casas de apostas online, jogos de sorte e azar, qualquer tipo de pornografia ilegal, apologia ao terrorismo ou contra os direitos humanos;</p>
            <p>c - Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do teste, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</p>
